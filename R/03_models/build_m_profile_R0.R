...
build_m_profile <- function(
  ...
  message("  m_critical = R0'in 1.0'i astigi m degeri")
  message("  m_critical < 1.0  : baz senaryoda (m=1) superkritik")
  message("  m_critical 1.0-2.0: OAT araliginda alt-ust kritik gecis")
  message("  m_critical > 2.0  : tum makul m araliginda subkritik")
